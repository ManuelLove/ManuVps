...
exports.run = {
   ...
   async: async (m, { 
      ...
      try {
         ...
         // Usar una URL temporal para la subida de archivo
         ...
         // Descargar el audio o video desde YouTube usando la URL proporcionada
         ...
         if (!audioURL) {
            throw new Error('No se pudo obtener la URL del audio de YouTube')
         }
